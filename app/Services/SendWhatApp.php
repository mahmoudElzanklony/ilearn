...
class SendWhatApp
{
    public static function send($number,$password,$username = '')
    {
        ...
        $message = '*مساء الخير يرجي تسجيل الرقم .*'.'<br />'.
            '  تم انشاء حساب جديد في تطبيق *I Learn* بأسم  '.$username.' رقم الهاتف هو '.$number.' و كلمة المرور الخاصة بك هي '.$password.'<br />'
            .' علما بأن رابط التطبيق علي جوجل بلاي هو '.$google_play.' و ابل ستور  '.$apple_store.'<br />'
